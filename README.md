...
För att testa applikationen startas först backend genom kommandot json-server --watch db.json --port 3001 i mappen Movie-seat-api.
...
Strukturerade om dataflödet där frontend anropar API route och därefter hämtar API routen data från json server.
